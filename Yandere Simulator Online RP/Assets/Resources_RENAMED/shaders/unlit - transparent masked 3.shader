	...
	SubShader {
		...
		Pass {
			...
			v2f vert(appdata_full v)
			{
                ...
                o.texcoord2.zw = tmp0.zw * _ClipRange1.zw + _ClipRange1.xy;
                o.texcoord2.xy = v.vertex.xy * _ClipRange0.zw + _ClipRange0.xy;
                tmp0.x = v.vertex.y * _ClipArgs2.z;
                tmp0.x = v.vertex.x * _ClipArgs2.w + -tmp0.x;
                tmp0.y = dot(v.vertex.xy, _ClipArgs2.xy);
                o.texcoord3.xy = tmp0.xy * _ClipRange2.zw + _ClipRange2.xy;
                o.color = v.color;
                return o;
			}
			// Keywords: 
